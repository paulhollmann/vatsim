...
& M/L+3/4H+J if able                 & \textbf{1H} \textcolor{blue}{L}                & \textbf{4H} \textcolor{blue}{L}                & \textbf{4H} \textcolor{blue}{L}               &                                                  \\ \arrayrulecolor{red}\cline{2-6}\arrayrulecolor{gray}
                    ...
                    & H/J or unable                      & 1D                         & 9D                         & 9D                         &                                                  \\ \arrayrulecolor{red}\cline{1-5}\arrayrulecolor{gray}
\multirow{2}{*}{\textbf{07}} & M/L if able                        & \textbf{1E}                & \textbf{5E}                & \textbf{9D}                &                                                  \\ \cline{2-5}
                    & H/S or unable                      & \textbf{1D}                & \textbf{9D}                & \textbf{9D}                &                                                  \\ \arrayrulecolor{red}\cline{1-6}\arrayrulecolor{gray}
...
\multirow{3}{*}{\textbf{25}} & Prop 1/2         & 5P                                          &                                             &                          &                          &                                    &                          &                                  \\ \cline{2-8}
                             ...
                             & Night departures & 6N                                          &                                             &                          &                          &                                    &                          &                                  \\  \arrayrulecolor{red}\hline\arrayrulecolor{gray}
\multirow{2}{*}{\textbf{07}} & M/L if able      & 6E                                          &                                             & 4E                       & 1D                       & 3D                                 & \textbf{1D}              & \multirow{5}{*}{\rotatebox{90}{\textbf{4000 ft}}} \\ \cline{2-8}
                             & H/J or unable    & 6D                                          &                                             & 2D                       & 1D                       & 3D                                 & \textbf{1D}              &                                  \\ \arrayrulecolor{red}\cline{1-8}\arrayrulecolor{gray}
...
\multirow{6}{*}{\rotatebox{90}{GND}} & \textbf{FAC} & \textbf{121.855} & \textbf{Center Apron}    \\ %\cline{2-4}
                     & FAE          & 121.950          & East Apron               \\ %\cline{2-4}
                     & FAW          & 121.750          & West Apron               \\ %\cline{2-4}
                     & FG           & 121.800          & Ground                   \\ %\cline{2-4}
                     & FAS          & 121.650          & South Apron              \\ %\cline{2-4}
...
\multirow{6}{*}{\rotatebox{90}{APP}} & \textbf{FN}  & \textbf{120.805} & \textbf{North Arrival}   \\ %\cline{2-4}
                     ...
                     & FU           & 118.500          & South Director           \\ %\cline{2-4}
